...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        values='Launch Site',
        names='class',
        title='Total Success / Failure Launches for ' + entered_site)
        return fig
...
#    filtered_df = spacex_df
    ...
    if entered_site == 'ALL':
        ...
        title='Payload Mass And Success Scatter')
        return fig
    else:
...
#                      (filtered_df['Payload Mass (kg)'] < payload[1])]
        ...
        y='class',
        color='Booster Version Category',
        title='Total Success / Failure Launches Based On Payload for  ' + entered_site)
        return fig
        # return the outcomes piechart for a selected site
